...
namespace tags {
    //! @brief Tag for setting a starting time of execution for nodes (defaults to `TIME_MAX`).
    struct start_time {};
}
        ...
        class node : public P::node {
          public: // visible by net objects and the main program
            ...
            node(typename F::net& n, const tagged_tuple<S,T>& t) : P::node(n,t), m_neigh(TIME_MIN) {
                ...
                m_next = get_or<tags::start_time>(t, TIME_MAX);
            ...
            void update() {
                m_prev = m_cur;
                m_cur = next();
                details::self(m_neigh, P::node::id) = m_prev;
                if (m_next < TIME_MAX) {
