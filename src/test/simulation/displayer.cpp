 ...
 */
DECLARE_COMBINE(interactive_simulator, displayer, logger, calculus, storage, spawner, simulated_connector, simulated_positioner, timer, scheduler, identifier, randomizer);
