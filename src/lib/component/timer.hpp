 ...
 * A \ref displayer component cannot be a parent of a \ref timer to preserve refresh rates.
 *
...
struct timer {
    ...
    struct component : public P {
        ...
        AVOID_COMPONENT(timer,displayer);
        ...
        class net : public P::net {
          ...
          public: // visible by node objects and the main program
            ...
            //! @brief Sets the warping factor applied to following schedulers (given current real time `t`).
            void frequency(real_t f, times_t t) {
                assert(t < TIME_MAX and 0 <= f and f < INF);
