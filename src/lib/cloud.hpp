 ...
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         */
DECLARE_COMBINE(batch_graph_simulator, graph_spawner, graph_connector, timer, logger, storage, identifier, randomizer, calculus, base);
 ...
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 */
DECLARE_COMBINE(interactive_graph_simulator, displayer, graph_spawner, graph_connector, simulated_positioner, timer, logger, storage, identifier, randomizer, calculus, base);
