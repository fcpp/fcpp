...
TEST(PlotTest, Value) {
    {
        ...
        plot::point& q = pb[0];
        EXPECT_POINT(q, "tag", "tag (finite_mean)", 3.0);
    }
    {
...
TEST(PlotTest, FilterValue) {
    {
        ...
        std::array<plot::point, 1> pb = p.build();
        plot::point& q = pb[0];
        EXPECT_POINT(q, "tag", "tag (finite_mean)", 5.0);
    }
    {
...
TEST(PlotTest, JoinValue) {
    {
        ...
        EXPECT_POINT(pb[0], "tag", "tag (finite_mean)", 5.0);
        EXPECT_POINT(pb[1], "gat", "gat (finite_mean)", 2.0);
    }
    {
...
TEST(PlotTest, Values) {
    ...
    EXPECT_POINT(pb[0], "gat",  "gat (distinct-finite_mean)", 1.0);
    EXPECT_POINT(pb[1], "gat",  "gat (mean-finite_mean)",     2.0);
    EXPECT_POINT(pb[2], "gat",  "gat (dev-finite_mean)",      3.0);
    EXPECT_POINT(pb[3], "temp", "tag (mean-finite_mean)",     4.0);
    EXPECT_POINT(pb[4], "temp", "gat (count-finite_mean)",    5.0);
    EXPECT_POINT(pb[5], "tag",  "tag (count-finite_mean)",    6.0);
    EXPECT_POINT(pb[6], "temp", "gat (count-finite_mean)",    5.0);
}
...
TEST(PlotTest, SplitJoinValue) {
    {
        ...
        std::stringstream ss;
        ss << pb[0];
        EXPECT_EQ(ss.str(), "plot.put(plot.plot(name+\"-timtemp\", \"\", \"time\", \"temp\", new string[] {\"tag (finite_mean)\", \"gat (finite_mean)\"}, new pair[][] {{(0, 10), (1, 5), (2, 0)}, {(0, 0), (1, 5), (2, 10)}}));\n");
    }
    {
...
TEST(PlotTest, FilterSplitValue) {
    ...
    std::stringstream ss;
    ss << pb[0];
    EXPECT_EQ(ss.str(), "plot.put(plot.plot(name+\"-ttagtemp\", \"\", \"temp<tag>\", \"temp\", new string[] {\"gat (finite_mean)\"}, new pair[][] {{(0, 10), (5, 5)}}));\n");
    ss.str("");
    plot::file f("experiment", pb);
    ss << f;
    EXPECT_EQ(ss.str(), "// experiment\nstring name = \"experiment\";\n\nimport \"plot.asy\" as plot;\nunitsize(1cm);\n\nplot.ROWS = 1;\nplot.COLS = 1;\n\nplot.put(plot.plot(name+\"-ttagtemp\", \"\", \"temp<tag>\", \"temp\", new string[] {\"gat (finite_mean)\"}, new pair[][] {{(0, 10), (5, 5)}}));\n\n\nshipout(\"experiment\");\n");
    ss.str("");
...
TEST(PlotTest, JoinFilterSplitJoinValue) {
    ...
    plot::file f("experiment", pb);
    ss << f;
    EXPECT_EQ(ss.str(), "// experiment\nstring name = \"experiment\";\n\nimport \"plot.asy\" as plot;\nunitsize(1cm);\n\nplot.ROWS = 1;\nplot.COLS = 2;\n\nplot.put(plot.plot(name+\"-timtemp\", \"\", \"time\", \"temp\", new string[] {\"tag (finite_mean)\", \"gat (finite_mean)\"}, new pair[][] {{(0, 10), (1, 5), (2, 0)}, {(0, 0), (1, 5), (2, 10)}}));\n\nplot.put(plot.plot(name+\"-ttagtemp\", \"\", \"temp<tag>\", \"temp\", new string[] {\"gat (finite_mean)\"}, new pair[][] {{(0, 10), (5, 5)}}));\n\n\nshipout(\"experiment\");\n");
}
...
TEST(PlotTest, SplitJoinFilterSplitJoinValue) {
    ...
    std::stringstream ss;
    ss << pb[0];
    EXPECT_EQ(ss.str(), "plot.ROWS = 2;\nplot.COLS = 2;\n\nplot.put(plot.plot(name+\"-timtemp-obut0\", \"oth but = 0\", \"time\", \"temp\", new string[] {\"tag (finite_mean)\", \"gat (finite_mean)\"}, new pair[][] {{(0, 10), (1, 5), (2, 0)}, {(0, 0), (1, 5), (2, 10)}}));\n\nplot.put(plot.plot(name+\"-ttagtemp-obut0\", \"oth but = 0\", \"temp<tag>\", \"temp\", new string[] {\"gat (finite_mean)\"}, new pair[][] {{(0, 10), (5, 5)}}));\n\nplot.put(plot.plot(name+\"-timtemp-obut10\", \"oth but = 10\", \"time\", \"temp\", new string[] {\"tag (finite_mean)\", \"gat (finite_mean)\"}, new pair[][] {{(0, 0), (1, 5), (2, 10)}, {(0, 10), (1, 5), (2, 0)}}));\n\nplot.put(plot.plot(name+\"-ttagtemp-obut10\", \"oth but = 10\", \"temp<tag>\", \"temp\", new string[] {\"gat (finite_mean)\"}, new pair[][] {{(5, 5), (10, 0)}}));\n\n");
    ss.str("");
    plot::file f("experiment", pb);
    ss << f;
    EXPECT_EQ(ss.str(), "// experiment\nstring name = \"experiment\";\n\nimport \"plot.asy\" as plot;\nunitsize(1cm);\n\nplot.ROWS = 2;\nplot.COLS = 2;\n\nplot.put(plot.plot(name+\"-timtemp-obut0\", \"oth but = 0\", \"time\", \"temp\", new string[] {\"tag (finite_mean)\", \"gat (finite_mean)\"}, new pair[][] {{(0, 10), (1, 5), (2, 0)}, {(0, 0), (1, 5), (2, 10)}}));\n\nplot.put(plot.plot(name+\"-ttagtemp-obut0\", \"oth but = 0\", \"temp<tag>\", \"temp\", new string[] {\"gat (finite_mean)\"}, new pair[][] {{(0, 10), (5, 5)}}));\n\nplot.put(plot.plot(name+\"-timtemp-obut10\", \"oth but = 10\", \"time\", \"temp\", new string[] {\"tag (finite_mean)\", \"gat (finite_mean)\"}, new pair[][] {{(0, 0), (1, 5), (2, 10)}, {(0, 10), (1, 5), (2, 0)}}));\n\nplot.put(plot.plot(name+\"-ttagtemp-obut10\", \"oth but = 10\", \"temp<tag>\", \"temp\", new string[] {\"gat (finite_mean)\"}, new pair[][] {{(5, 5), (10, 0)}}));\n\n\nshipout(\"experiment\");\n");
...
TEST(PlotTest, JoinSplitJoinFilterSplitJoinValue) {
    {
        ...
        ss.str("");
        ss << pb[1];
        EXPECT_EQ(ss.str(), "plot.ROWS = 1;\nplot.COLS = 1;\n\nplot.put(plot.plot(name+\"-ttagtemp\", \"\", \"temp<tag>\", \"temp\", new string[] {\"gat (finite_mean)\"}, new pair[][] {{(0, 10), (5, 5), (10, 0)}}));\n\n");
    }
    {
