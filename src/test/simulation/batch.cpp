...
TEST(BatchTest, Run) {
    ...
    w.push_back("(type_index_tag => 0; char => 1; double => 2)");
    w.push_back("(type_index_tag => 0; char => 1; double => 7)");
    w.push_back("(type_index_tag => 0; char => 2; double => 2)");
    w.push_back("(type_index_tag => 0; char => 2; double => 7)");
    w.push_back("(type_index_tag => 0; char => 5; double => 2)");
    w.push_back("(type_index_tag => 0; char => 5; double => 7)");
    w.push_back("(type_index_tag => 0; char => 8; double => 2)");
    w.push_back("(type_index_tag => 0; char => 8; double => 7)");
    w.push_back("(type_index_tag => 0; char => 1; double => 3)");
    w.push_back("(type_index_tag => 0; char => 2; double => 3)");
    w.push_back("(type_index_tag => 0; char => 4; double => 3)");
    w.push_back("(type_index_tag => 0; char => 1; double => 0)");
    w.push_back("(type_index_tag => 0; char => 2; double => 0)");
    w.push_back("(type_index_tag => 0; char => 4; double => 0)");
    w.push_back("(type_index_tag => 0; char => 1; double => 6)");
    w.push_back("(type_index_tag => 0; char => 2; double => 6)");
    w.push_back("(type_index_tag => 0; char => 4; double => 6)");
    EXPECT_EQ(v, w);
    v = {};
